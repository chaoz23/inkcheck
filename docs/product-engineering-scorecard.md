...
| **Author and agent intent** | Humans and agents can safely declare invariants, goals, deadlines, and resource posture; Inkcheck verifies them mechanically and explains what it could not establish. | **8/10** | Typed assertions, additive/staged goals, exact replay, regression pins, and named MCP/CLI campaign modes cover deadline/resource/value/stop posture with attributable explanations; hosted authors get Quick/Balanced outcome-and-time choices. Directed campaign children, causal goal quality, and the hosted assistant remain (#66, #81, #86, #87). |
