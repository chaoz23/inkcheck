...
| **Anytime value per wall clock** | Users receive useful result windows early; allocation, long-tail probing, deadlines, and stopping adapt to measured yield and resources without hiding uncertainty. | **8/10** | Durable campaigns now execute exact base windows plus protected independent long-tail partitions. In a matched 5M Intercept campaign, independent children completed the budget at 1.41 GiB peak heap while the growing frontier stopped at 786,559 states and 3.70 GiB; at about 107 seconds of additional work they credited 1,538 new terminal variants versus 407. No new critical/authored/outcome evidence appeared, and corpus-proven value-weighted stopping remains (#93). |
...
| **Portfolio-marginal value accounting** | Explorers and specialists earn discretionary work only for portfolio-new evidence or explicit intent progress; duplicate rediscovery is visible but not double-paid. | **8/10** | Campaign children deduplicate canonical evidence across prior reports, while independent-child ledgers now preserve compact observed-versus-campaign-new category counts and report-local discovery spacing. The shadow decision exposes selected-value rediscovery without treating it as a duplicate-state rate or plateau proof. Live use of these signals and broader corpus evidence remain gated by #180. |
...
| **Inspectable decisions** | Every automatic activation, allocation, forecast, contraction, and stop records policy version, factual inputs, uncertainty, reason, and binding constraint in compact human/agent forms. | **9/10** | Compact MCP output includes concurrency activation evidence plus a versioned shadow-only long-tail recommendation with value preference, floor, authorization, rates, trend, selected-value rediscovery, report-local discovery gaps, uncertainty, and explicit unavailable signals for old ledgers. `liveEffect: false` keeps observation distinct from execution. Promoted multi-child selection and externally accounted cost decisions remain absent (#180, #152). |
