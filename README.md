...
```
inkcheck <story.ink> [--max-depth N] [--max-states N] [--seed N] [--search=portfolio|shared] [--auto] [--profile] [--next] [--no-min-repro] [--strict] [--progress=auto|human|ndjson|off] [--human|--json|--markdown]
